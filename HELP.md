...
* [Spring for Apache ActiveMQ Artemis](https://docs.spring.io/spring-boot/4.0.5/reference/messaging/jms.html#messaging.jms.artemis)
...
* [Cassandra](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.cassandra)
...
* [Cloud Foundry](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/cloud-foundry.html)
...
* [Couchbase](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.couchbase)
* [Spring Data for Apache Cassandra](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.cassandra)
* [Spring Data Reactive for Apache Cassandra](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.cassandra)
* [Spring Data Couchbase](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.couchbase)
* [Spring Data Reactive Couchbase](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.couchbase)
...
* [Spring Data Reactive MongoDB](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.mongodb)
...
* [Datadog](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/metrics.html#actuator.metrics.export.datadog)
...
* [Dynatrace](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/metrics.html#actuator.metrics.export.dynatrace)
* [Elasticsearch](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.elasticsearch)
* [Apache Freemarker](https://docs.spring.io/spring-boot/4.0.5/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
* [Graphite](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/metrics.html#actuator.metrics.export.graphite)
* [Spring for GraphQL](https://docs.spring.io/spring-boot/4.0.5/reference/web/spring-graphql.html)
* [Groovy Templates](https://docs.spring.io/spring-boot/4.0.5/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
* [Spring HATEOAS](https://docs.spring.io/spring-boot/4.0.5/reference/web/spring-hateoas.html)
* [Hazelcast](https://docs.spring.io/spring-boot/4.0.5/reference/io/hazelcast.html)
* [htmx](https://github.com/wimdeblauwe/htmx-spring-boot)
* [Influx](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/metrics.html#actuator.metrics.export.influx)
...
* [Jersey](https://docs.spring.io/spring-boot/4.0.5/reference/web/servlet.html#web.servlet.jersey)
...
* [Neo4j](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.neo4j)
* [Netflix DGS](https://netflix.github.io/dgs/)
* [New Relic](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/metrics.html#actuator.metrics.export.newrelic)
...
* [OTLP for metrics](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/metrics.html#actuator.metrics.export.otlp)
...
* [CycloneDX SBOM support](https://docs.spring.io/spring-boot/4.0.5/reference/actuator/endpoints.html#actuator.endpoints.sbom)
...
* [Embedded LDAP Server](https://docs.spring.io/spring-boot/4.0.5/reference/data/nosql.html#data.nosql.ldap.embedded)
...
```
$ docker run --rm -p 8080:8080 QEdu:0.0.1-SNAPSHOT
```
